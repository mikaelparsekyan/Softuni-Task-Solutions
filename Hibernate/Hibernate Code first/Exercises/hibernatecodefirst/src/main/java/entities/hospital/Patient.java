...
import entities.hospital.enums.PatientInformation;
...
public class Patient extends BaseEntity {
    ...
    private String picture; // the url of the picture
    ...
    @OneToMany(targetEntity = Medicament.class, fetch = FetchType.LAZY,
            cascade = CascadeType.ALL)
