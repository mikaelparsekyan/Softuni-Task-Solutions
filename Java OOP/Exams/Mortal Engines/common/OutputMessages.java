...
public class OutputMessages {
    ...
    public static final String MACHINE_NAME_EMPTY = "Machine name cannot be null or empty.";

    public static final String PILOT_NULL = "Pilot cannot be null.";

    public static final String PILOT_NAME_EMPTY = "Pilot name cannot be null or empty string.";

    public static final String ATTACK_TARGET_EMPTY = "Attack target cannot be null or empty string.";
}
